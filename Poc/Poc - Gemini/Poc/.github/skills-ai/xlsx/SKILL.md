...
```bash
python .github/skills-ai/xlsx/scripts/extract_xlsx.py rfp/data-model.xlsx
```

**Example:**
```bash
python .github/skills-ai/xlsx/scripts/extract_xlsx.py rfp/requirements-matrix.xlsx > /tmp/xlsx_extracted.md
```
...
python .github/skills-ai/xlsx/scripts/extract_xlsx.py rfp/data.xlsx --sheet "Functional Requirements"

# List all sheet names without extracting content
python .github/skills-ai/xlsx/scripts/extract_xlsx.py rfp/data.xlsx --list-sheets
```
...
python .github/skills-ai/xlsx/scripts/extract_xlsx.py rfp/large-data.xlsx --max-rows 100
```
