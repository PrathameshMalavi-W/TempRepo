...
```bash
python .github/skills/pptx/scripts/extract_pptx.py rfp/presentation.pptx
```

**Example:**
```bash
python .github/skills/pptx/scripts/extract_pptx.py rfp/solution-overview.pptx > /tmp/pptx_extracted.md
```
