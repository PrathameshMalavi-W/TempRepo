...
```bash
python .github/skills/docx/scripts/extract_docx.py <path-to-file.docx>
```

**Example:**
```bash
python .github/skills/docx/scripts/extract_docx.py rfp/requirements.docx
```
...
```bash
python .github/skills/docx/scripts/extract_docx.py rfp/requirements.docx > /tmp/docx_extracted.md
```
...
python .github/skills/docx/scripts/extract_docx.py rfp/requirements.docx --section "Functional Requirements"
```
