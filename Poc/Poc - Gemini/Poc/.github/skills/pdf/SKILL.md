...
```bash
python .github/skills/pdf/scripts/extract_pdf.py rfp/document.pdf --check-type
```
...
```bash
python .github/skills/pdf/scripts/extract_pdf.py rfp/document.pdf
```

**Example:**
```bash
python .github/skills/pdf/scripts/extract_pdf.py rfp/tender-requirements.pdf > /tmp/pdf_extracted.md
```
...
```bash
python .github/skills/pdf/scripts/extract_pdf.py rfp/scanned.pdf --pages 1-5
```
...
python .github/skills/pdf/scripts/extract_pdf.py rfp/document.pdf --pages 10-25

# Extract a single page
python .github/skills/pdf/scripts/extract_pdf.py rfp/document.pdf --pages 15
```
