#libs-Folder => angular-webcomponents

********************************************************************************************************************************

FIle => onecx-portal-ui-libs > libs > angular-webcomponents > src > index.ts
...
FIle => onecx-portal-ui-libs > libs > angular-webcomponents > src > lib > utils > webcomponent-bootstrap.utils
...
FIle => onecx-portal-ui-libs > libs > angular-webcomponents > src > lib > utils > dynamic-app-id.utils
...
FIle => onecx-portal-ui-libs > libs > angular-webcomponents > src > lib > utils > webcomponent-router-initializer.utils
...
FIle => onecx-portal-ui-libs > libs > angular-webcomponents > src > lib > utils > webcomponent-router.utils
...
FIle => onecx-portal-ui-libs > libs > angular-webcomponents > src > lib > utils > webcomponent-connector.utils
...
FIle => onecx-portal-ui-libs > libs > angular-webcomponents > src > lib > utils > webcomponent-connector.spec.utils
