...
## Folder: nx-migration-utils (8 files)

### File: nx-migration-utils/.eslintrc.json
...
### File: nx-migration-utils/jest.config.ts
...
### File: nx-migration-utils/package.json
...
### File: nx-migration-utils/project.json
...

{
  ...
  "targets": {
    ...
    "test-migrations": {
      ...
      "options": {
        "jestConfig": "libs/nx-migration-utils/src/lib/migrations/jest.config.ts",
    ...
    "test": {
      ...
      "options": {
        ...
        "passWithNoTests": true,
        "testPathIgnorePatterns": ["libs/nx-migration-utils/migrations/"]
      },
      "configurations": {
        "ci": {
          "ci": true,
...
### File: nx-migration-utils/sonar-project.properties
...
sonar.projectKey=onecx-portal-ui-libs-nx-migration-utils
sonar.projectName=onecx-portal-ui-libs-nx-migration-utils
#
...
sonar.javascript.lcov.reportPaths=../../reports/nx-migration-utils/coverage/lcov.info
sonar.testExecutionReportPaths=../../reports/nx-migration-utils/sonarqube_report.xml
sonar.working.directory=../../reports/nx-migration-utils/.scannerwork
# files
...
### File: nx-migration-utils/tsconfig.json
...
### File: nx-migration-utils/tsconfig.lib.json
...
### File: nx-migration-utils/tsconfig.spec.json
...
## Folder: nx-migration-utils/src (2 files)

### File: nx-migration-utils/src/index.ts
...
### File: nx-migration-utils/src/test-setup.ts
...
## Folder: nx-migration-utils/src/lib/angular (4 files)

### File: nx-migration-utils/src/lib/angular/html-templates.utils.ts
...
### File: nx-migration-utils/src/lib/angular/index.ts
...
### File: nx-migration-utils/src/lib/angular/parameters.utils.ts
...
### File: nx-migration-utils/src/lib/angular/replacement-in-files.utils.ts
...
## Folder: nx-migration-utils/src/lib/angular/model (3 files)

### File: nx-migration-utils/src/lib/angular/model/matching-module.model.ts
...
### File: nx-migration-utils/src/lib/angular/model/module.model.ts
...
### File: nx-migration-utils/src/lib/angular/model/provider.model.ts
...
## Folder: nx-migration-utils/src/lib/angular/utils/detection (3 files)

### File: nx-migration-utils/src/lib/angular/utils/detection/detect-modules-importing-module.utils.ts
...
### File: nx-migration-utils/src/lib/angular/utils/detection/detect-variables-with-module.utils.ts
...
### File: nx-migration-utils/src/lib/angular/utils/detection/detect-variables-with-provider.utils.ts
...
## Folder: nx-migration-utils/src/lib/angular/utils/modification (4 files)

### File: nx-migration-utils/src/lib/angular/utils/modification/add-provider-import-if-does-not-exist.utils.ts
...
### File: nx-migration-utils/src/lib/angular/utils/modification/add-provider-import-in-file.utils.ts
...
### File: nx-migration-utils/src/lib/angular/utils/modification/add-provider-in-module.utils.ts
...
### File: nx-migration-utils/src/lib/angular/utils/modification/add-provider-in-module-if-does-not-exist.utils.ts
...
## Folder: nx-migration-utils/src/lib/angular/utils (1 files)

### File: nx-migration-utils/src/lib/angular/utils/patterns.utils.ts
...
## Folder: nx-migration-utils/src/lib/angular/utils/validation (2 files)

### File: nx-migration-utils/src/lib/angular/utils/validation/is-provider-import-in-file.utils.ts
...
### File: nx-migration-utils/src/lib/angular/utils/validation/is-provider-in-module.utils.ts
...
## Folder: nx-migration-utils/src/lib/common-migrations (1 files)

### File: nx-migration-utils/src/lib/common-migrations/common-migrate-onecx-to-v6.utils.ts
...
function removeOnecxPortalLayoutStyles(tree: Tree) {
  const warning =
    'âš ï¸ @onecx/portal-layout-styles library was removed. Please make sure that all references are removed and the application is not relying on @onecx/portal-layout-styles style sheets.'
...
function warnUserServiceHasPermission(tree: Tree, srcDirectoryPath: string) {
  const warningHasPermissionCalls =
    'âš ï¸ UserService hasPermission is now asynchronous. Please adapt the usages accordingly, so that they are handled asynchronously.'
...
function warnOcxPortalViewport(tree: Tree, directoryPath: string) {
  ...
  const warning =
    'âš ï¸ ocx-portal-viewport was removed. Please refer to the standalone guide for adaptations: https://onecx.github.io/docs/guides/current/angular/cookbook/migrations/enable-standalone/index.html'
...
## Folder: nx-migration-utils/src/lib/migrations (4 files)

### File: nx-migration-utils/src/lib/migrations/jest.config.ts
...
### File: nx-migration-utils/src/lib/migrations/tsconfig.json
...
### File: nx-migration-utils/src/lib/migrations/tsconfig.migrations.json
...
### File: nx-migration-utils/src/lib/migrations/tsconfig.spec.json
...
## Folder: nx-migration-utils/src/lib/migrations/v6 (6 files)

### File: nx-migration-utils/src/lib/migrations/v6/remove-pia-imports.spec.ts
...
### File: nx-migration-utils/src/lib/migrations/v6/remove-pia-imports.ts
...
### File: nx-migration-utils/src/lib/migrations/v6/replace-pia-imports.spec.ts
...
### File: nx-migration-utils/src/lib/migrations/v6/replace-pia-imports.ts
...
### File: nx-migration-utils/src/lib/migrations/v6/replace-portal-core-module.spec.ts
...
### File: nx-migration-utils/src/lib/migrations/v6/replace-portal-core-module.ts
...
## Folder: nx-migration-utils/src/lib/utils/detection (1 files)

### File: nx-migration-utils/src/lib/utils/detection/detect-variables-with-identifier.utils.ts
...
## Folder: nx-migration-utils/src/lib/utils (8 files)

### File: nx-migration-utils/src/lib/utils/detect-method-calls-in-files.ts
...
### File: nx-migration-utils/src/lib/utils/detect-method-calls-in-files.utils.ts
...
### File: nx-migration-utils/src/lib/utils/import-statements.utils.ts
...
### File: nx-migration-utils/src/lib/utils/patterns.utils.ts
...
### File: nx-migration-utils/src/lib/utils/print-warnings.ts
...
### File: nx-migration-utils/src/lib/utils/print-warnings.utils.ts
...
### File: nx-migration-utils/src/lib/utils/typescript-files.utils.ts
...
### File: nx-migration-utils/src/lib/utils/update-gitignore.utils.ts
...
## Folder: nx-migration-utils/src/lib/utils/modification (10 files)

### File: nx-migration-utils/src/lib/utils/modification/add-new-import.utils.ts
...
### File: nx-migration-utils/src/lib/utils/modification/add-to-first-import.utils.ts
...
### File: nx-migration-utils/src/lib/utils/modification/remove-import-specifier.utils.spec.ts
...
### File: nx-migration-utils/src/lib/utils/modification/remove-import-specifier.utils.ts
...
### File: nx-migration-utils/src/lib/utils/modification/remove-json-references.utils.ts
...
### File: nx-migration-utils/src/lib/utils/modification/replace-tag-in-html.utils.ts
...
### File: nx-migration-utils/src/lib/utils/modification/update-json-files.utils.ts
...
### File: nx-migration-utils/src/lib/utils/modification/update-style-sheet.utils.spec.ts
...
### File: nx-migration-utils/src/lib/utils/modification/update-style-sheet.utils.ts
...
### File: nx-migration-utils/src/lib/utils/modification/update-style-sheets.utils.ts
...
## Folder: nx-migration-utils/src/lib/utils/validation (5 files)

### File: nx-migration-utils/src/lib/utils/validation/has-html-tag.utils.ts
...
### File: nx-migration-utils/src/lib/utils/validation/is-file-style-sheet.utils.ts
...
### File: nx-migration-utils/src/lib/utils/validation/is-import-in-content.utils.ts
...
### File: nx-migration-utils/src/lib/utils/validation/is-import-in-file-content.utils.ts
...
### File: nx-migration-utils/src/lib/utils/validation/is-namespace-import-in-content.utils.ts
