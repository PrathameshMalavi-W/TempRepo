...
## Folder: onecx-parameter-ui/src/assets (1 files)

### File: onecx-parameter-ui/src/assets/env.json

```json

{
  "APP_ELEMENT_NAME": "${APP_ELEMENT_NAME}"
}


```

## Folder: onecx-parameter-ui/src/assets/i18n (2 files)

### File: onecx-parameter-ui/src/assets/i18n/de.json
...

{
  "ACTIONS": {
    "LABEL": "Aktionen",
    "TOOLTIP": "Aktionen fÃ¼r die Daten der Tabellenzeile",
    "CONFIRMATION": {
      "QUESTION": "Frage",
      "NO": "Nein",
      "YES": "Ja",
      "NO.TOOLTIP": "Nein - Abbruch der Aktion",
      "YES.TOOLTIP": "Ja - Fortfahren mit der Aktion"
    },
    "COPY": {
      "LABEL": "Kopieren",
      ...
      "MESSAGE": {
        "OK": "Der Parameter wurde erfolgreich erstellt",
        "NOK": "Ein Fehler ist aufgetreten. Der Parameter wurde nicht erstellt."
      }
    },
    "CREATE": {
      "LABEL": "Erstellen",
      "TOOLTIP": "Einen neuen Parameter erstellen",
      "MESSAGE": {
        "OK": "Der Parameter wurde erfolgreich erstellt",
        "NOK": "Ein Fehler ist aufgetreten. Der Parameter wurde nicht erstellt."
      }
    ...
    "DELETE": {
      "LABEL": "LÃ¶schen",
      "TOOLTIP": "Parameter lÃ¶schen",
      "MESSAGE": {
        "TEXT": "MÃ¶chten Sie diesen Parameter lÃ¶schen?",
        "INFO": "Diese Aktion kann nicht rÃ¼ckgÃ¤ngig gemacht werden!",
        "OK": "Der Parameter erfolgreich gelÃ¶scht",
        "NOK": "Der Parameter konnte nicht gelÃ¶scht werden"
      }
    },
    "EDIT": {
      "LABEL": "Bearbeiten",
      "TOOLTIP": "Parameter Ã¤ndern",
      "MESSAGE": {
        "OK": "Der Parameter wurde erfolgreich geÃ¤ndert.",
        "NOK": "Ein Fehler ist aufgetreten. Der Parameter wurde nicht geÃ¤ndert."
      }
    },
    "EXPORT": {
      "LABEL": "Export",
      ...
      "MESSAGE": {
        "OK": "Die Parameter wurden erfolgreich exportiert.",
        "NOK": "Ein Fehler ist aufgetreten. Die Parameter konnten nicht exportiert werden."
      }
    },
    "IMPORT": {
      "LABEL": "Import",
      "TOOLTIP": "Definition als JSON hochladen",
      "MESSAGE": {
        "OK": "Die Parameter wurden erfolgreich importiert.",
        "NOK": "Ein Fehler ist aufgetreten. Die Parameter wurden nicht importiert."
      }
    },
    "NAVIGATION": {
      "CLOSE": "SchlieÃŸen",
      "CLOSE.TOOLTIP": "Dialog schlieÃŸen",
      "CLOSE_WITHOUT_SAVE": "Dialog ohne Ã„nderungen schlieÃŸen",
      "BACK": "ZurÃ¼ck",
      "NEXT": "Weiter",
      "NEXT.TOOLTIP": "NÃ¤chste Seite",
      "BACK.TOOLTIP": "Vorherige Seite"
    },
    "SEARCH": {
      ...
      "OF": "von",
      "CRITERIA": {
        "NO_PRODUCT": "Keine Applikationen",
        "NO_APP": "Zuerst Applikation wÃ¤hlen"
      },
      "MESSAGE": {
        "NO_RESULTS": "Die Suche ergab keine Treffer",
        "SEARCH_FAILED": "Suche ist fehlgeschlagen"
      }
    },
    "VIEW": {
      "LABEL": "Details",
      "TOOLTIP": "Parameterdetails"
    },
    "CANCEL": "Abbrechen",
    "CHOOSE": "WÃ¤hlen",
    "LOADING": "Laden...",
    ...
    "TOOLTIPS": {
      ...
      "CANCEL_AND_CLOSE": "Abbrechen und Dialog schlieÃŸen",
      "CANCEL_WITHOUT_SAVE": "Die Aktion ohne Speichern abbrechen",
      "SAVE": "Die Ã„nderungen speichern",
  ...
  "INTERNAL": {
    "HEADER": "Intern",
    "TOOLTIP": "Interne Eigenschaften",
    "CREATION_DATE": "Erstellt am",
    "CREATION_USER": "Erstellt von",
    "MODIFICATION_DATE": "GeÃ¤ndert am",
    "MODIFICATION_USER": "GeÃ¤ndert von",
    "OPERATOR": "Automatisiert erstellt",
    "TOOLTIPS": {
      "CREATION_DATE": "Zeitpunkt der Erstellung",
      "CREATION_USER": "Name des Benutzers der Erstellung",
      "MODIFICATION_DATE": "Zeitpunkt der letzten Ã„nderung",
      "MODIFICATION_USER": "Name des Benutzers der letzten Ã„nderung",
      "OPERATOR": "Wenn gesetzt, dann wurde der Parameter automatisiert erstellt. Alle Ã„nderungen gehen beim beim nÃ¤chsten Deployment verloren."
    }
  },
  "DIALOG": {
    "SEARCH": {
      "HEADER": "Parameter Management",
      "SUBHEADER": "Suchen und verwalten von Parametern zur Konfiguration von Applikationen"
    },
    "NAVIGATION": {
      "SEARCH": {
        "LABEL": "Parameter",
        "TOOLTIP": "Liste der erfassten Parameter"
      },
      "DETAIL_USAGE": {
        "LABEL": "Nutzungsdaten",
        "TOOLTIP": "Von den Applikationen gemeldete Nutzungsdaten"
      },
      "LATEST_USAGE": {
        "LABEL": "Nutzungsdaten",
        "TOOLTIP": "Von den Applikationen gemeldete letzte Nutzungsdaten"
      }
    },
    "DETAIL": {
      "COPY.HEADER": "Parameter erstellen",
      "CREATE.HEADER": "Parameter erstellen",
      "DELETE.HEADER": "Parameter lÃ¶schen",
      "EDIT.HEADER": "Parameter Ã¤ndern",
      "VIEW.HEADER": "Parameter Details",
      "TAB": {
        "PROPS": "Eigenschaften",
        "VALUE": "Wert",
        "IMPORT_VALUE": "Importierter Wert",
        "INTERN": "Intern",
        "TOOLTIPS": {
          "PROPS": "Basiseigenschaften des Parameters",
          "VALUE": "Parameterwert",
          "IMPORT_VALUE": "Importierter Parameterwert",
          "INTERN": "Interne Eigenschaften"
        }
      },
      "CHARACTERS": "Noch mÃ¶gliche Zeichen"
    },
    "USAGE": {
      "HEADER": "Parameternutzung",
      "SUBHEADER": "Suchen und Anzeige der letzten Verwendung von Parametern (von Applikationen gemeldet)",
      "TAB": {
        "OVERVIEW": "Zusammenfassung",
        "LIST": "Werteliste",
        "CHART": "Zeitleiste",
        "TOOLTIPS": {
          "OVERVIEW": "Ãœberblick Ã¼ber die erfassten Daten des Parameters",
          "LIST": "Liste der Einzelwerte",
          "CHART": "Grafische Darstellung der Werte"
        }
      },
      "DETAIL": {
        "HEADER": "Nutzungsdetails",
        "LABEL": "Details"
      }
    },
    "CHART": {
    ...
    "DATAVIEW": {
      ...
      "FILTER_BY": "Filter fÃ¼r ",
      "FILTER_CLEAR": "Filter entfernen",
      "FILTER_PLACEHOLDER": "Filter"
    }
  },
  "PARAMETER": {
    "PRODUCT_NAME": "Applikation",
    "APP_ID": "App",
    "APP_NAME": "App",
    "PRODUCT_APP": "App",
    "NAME": "Name",
    ...
    "VALUE": "Wert",
    "VALUE.EMPTY": "Es ist kein Wert gespeichert.",
    "VALUE.TYPE": "Typ",
    "IMPORT_VALUE": "Importwert",
    "DESCRIPTION": "Beschreibung",
    "OPERATOR": "Auto",
    "EQUAL": "Gleich?",
    "TOOLTIPS": {
      "PRODUCT_NAME": "Applikation, fÃ¼r die der Parameter angelegt ist",
      "APP_ID": "App ID (Service), fÃ¼r die der Parameter angelegt ist",
      "APP_NAME": "App (Service), fÃ¼r die der Parameter angelegt ist",
      "PRODUCT_APP": "Applikation und App (Service), fÃ¼r die der Parameter angelegt ist",
      "NAME": "Name des Parameters",
      "COMBINED_NAME": "Anzeigename oder Name des Parameters",
      "DISPLAY_NAME": "Anzeigename des Parameters",
      "DESCRIPTION": "Detaillierte Beschreibung des Parameters",
      "VALUE": "Wert des Parameters - entspricht dem importierten Wert wenn nur dieser vorhanden.",
      "VALUE.TYPE": "Der Typ des Parameterwertes. Wenn die Typen unterschiedlich sind, dann beide Typen.",
      "VALUE.TYPE.DETAIL": "Der Typ des Parameterwertes.",
      "IMPORT_VALUE": "Importierter Wert",
      "OPERATOR": "Wenn gesetzt, dann wurde der Parameter automatisiert erstellt.",
      "EQUAL": "Vergleich von Wert und importiertem Wert",
      "EQUAL.TRUE": "Wert und importierter Wert sind gleich",
      "EQUAL.FALSE": "Wert und importierter Wert sind ungleich",
      "EQUAL.UNDEFINED": "Nicht anwendbar/verfÃ¼gbar, da kein Wert"
    }
  },
  "USAGE": {
    "COUNT": "Anzahl",
    ...
    "USED_VALUE": "Verwendet",
    "LAST_USED": "Zuletzt verwendet",
    "USAGE_RELOAD": "Neuladen",
    "EQUAL": "Gleich?",
    "TOOLTIPS": {
      "COUNT": "Wie oft im Interval benutzt?",
      "START": "Beginn des Zeitraums",
      "END": "Ende des Zeitraums",
      "DURATION": "Zeitraum in dem der Parameter mit dem geliefertem Wert benutzt wurde",
      "INSTANCE_ID": "ID der Instanz, die den Parameter benutzt hat",
      "DEFAULT_VALUE": "Standardwert",
      "USED_VALUE": "Verwendeter Wert",
      "LAST_USED": "Zuletzt verwendet",
      "EQUAL": "Vergleich von Wert und importiertem Wert",
      "EQUAL.TRUE": "Benutzter Wert und Default-Wert sind gleich",
      "EQUAL.FALSE": "Benutzter Wert und Default-Wert sind ungleich",
      "EQUAL.UNDEFINED": "Nicht anwendbar/verfÃ¼gbar, da kein Wert"
    }
  },
  "VALUE_TYPE": {
    ...
    "STRING": "Text",
    "UNKNOWN": "n.a.",
    "UNKNOWN.TOOLTIP": "Nicht anwendbar/verfÃ¼gbar, da kein Wert"
  },
  "VALIDATION": {
    "JSON_FORMAT": "{ \"key\": \"value\", ... }",
    "ERRORS": {
      "PERSIST_ENTITY_FAILED": "Ein Parameter mit diesem Namen existert schon fÃ¼r die Applikation.",
      "EMPTY_REQUIRED_FIELD": "Pflichtfeld",
      "FORM_MANDATORY": "Pflichtfelder fehlen",
      "MAXIMUM_LENGTH": "Es sind nur {{chars}} Zeichen erlaubt.",
      "MINIMUM_LENGTH": "Es sind mindestens {{chars}} Zeichen erforderlich.",
      "PATTERN_ERROR": "Ihre Eingabe entspricht nicht dem benÃ¶tigten Format."
    }
  },
  "EXCEPTIONS": {
    "HTTP_STATUS_0": {
      "USAGE": "Unbekanntes Problem beim Abrufen von Nutzungsdaten - bitte versuchen Sie es noch einmal.",
      "PARAMETER": "Unbekanntes Problem beim Abrufen der Parameter-Daten - bitte versuchen Sie es noch einmal.",
      "PARAMETERS": "Unbekanntes Problem beim Abrufen von Parametern - bitte versuchen Sie es noch einmal.",
      "PRODUCTS": "Unbekanntes Problem beim Abrufen von Applikationen - bitte versuchen Sie es noch einmal."
    },
    "HTTP_STATUS_400": {
      "USAGE": "Ihre Anfrage konnte nicht bearbeitet werden.",
      "PARAMETER": "Ihre Anfrage konnte nicht bearbeitet werden.",
      "PARAMETERS": "Ihre Anfrage konnte nicht bearbeitet werden.",
      "PRODUCTS": "Ihre Anfrage konnte nicht bearbeitet werden."
    },
    "HTTP_STATUS_401": {
      "USAGE": "Sie sind nicht autorisiert, um Nutzungsdaten zu sehen.",
      "PARAMETER": "Sie sind nicht autorisiert, um Parameter zu sehen.",
      "PARAMETERS": "Sie sind nicht autorisiert, um Parameter zu sehen.",
      "PRODUCTS": "Sie sind nicht autorisiert, um Applikationen zu sehen."
    },
    "HTTP_STATUS_403": {
      "USAGE": "Sie haben keine Rechte, um Nutzungsdaten zu sehen.",
      "PARAMETER": "Sie haben keine Rechte, um Parameter zu sehen.",
      "PARAMETERS": "Sie haben keine Rechte, um Parameter zu sehen.",
      "PRODUCTS": "Sie haben keine Rechte, um Applikationen zu sehen."
    },
    "HTTP_STATUS_404": {
      "USAGE": "Es konnten keine Nutzungsdaten geladen werden.",
      "PARAMETER": "Parameter nicht gefunden.",
      "PARAMETERS": "Es konnten keine Parameter geladen werden.",
      "PRODUCTS": "Es konnten keine Applikationen geladen werden."
    },
    "HTTP_STATUS_500": {
      "USAGE": "Unbekanntes Server-Problem beim Abrufen von Nutzungsdaten - bitte versuchen Sie es noch einmal.",
      "PARAMETER": "Unbekanntes Server-Problem beim Abrufen der Parameter - bitte versuchen Sie es noch einmal.",
      "PARAMETERS": "Unbekanntes Server-Problem beim Abrufen der Parameter - bitte versuchen Sie es noch einmal.",
      "PRODUCTS": "Unbekanntes Server-Problem beim Abrufen von Applikationen - bitte versuchen Sie es noch einmal."
    }
  }
}
...
### File: onecx-parameter-ui/src/assets/i18n/en.json
...

{
  "ACTIONS": {
    "LABEL": "Actions",
    "TOOLTIP": "Actions for the data of the table row",
    "CONFIRMATION": {
      "QUESTION": "Question",
      "NO": "No",
      "YES": "Yes",
      "NO.TOOLTIP": "No - Cancel the action",
      "YES.TOOLTIP": "Yes - Proceed with the action"
    },
    "COPY": {
      "LABEL": "Copy",
      ...
      "MESSAGE": {
        "OK": "The Parameter was created successfully",
        "NOK": "An error has occurred. The Parameter was not created."
      }
    },
    "CREATE": {
      "LABEL": "Create",
      "TOOLTIP": "Create a new Parameter",
      "MESSAGE": {
        "OK": "The Parameter was created successfully",
        "NOK": "An error has occurred. The Parameter was not created."
      }
    ...
    "DELETE": {
      ...
      "MESSAGE": {
        ...
        "OK": "Parameter deleted successfully",
        "NOK": "Parameter could not be deleted"
      }
    },
    "EDIT": {
      "LABEL": "Edit",
      ...
      "MESSAGE": {
        "OK": "The Parameter was changed successfully",
        "NOK": "An error has occurred. The Parameter was not changed."
      }
    },
    "EXPORT": {
      "LABEL": "Export",
      "TOOLTIP": "Export of selected Parameters in JSON format.",
      "MESSAGE": {
        "OK": "The Parameters were successfully exported.",
        "NOK": "An error has occurred. The Parameters could not be exported."
      }
    },
    "IMPORT": {
      "LABEL": "Import",
      ...
      "MESSAGE": {
        "OK": "The Parameters were successfully imported.",
        "NOK": "An error has occurred. The Parameters could not be imported."
      }
    },
    "NAVIGATION": {
      "CLOSE": "Close",
    ...
    "SEARCH": {
      ...
      "OF": "of",
      "CRITERIA": {
        "NO_PRODUCT": "No Applications",
        "NO_APP": "Select Application first"
      },
      "MESSAGE": {
  ...
  "INTERNAL": {
    ...
    "TOOLTIPS": {
      ...
      "OPERATOR": "If set, the Workspace was created by automation. All changes will be lost during the next deployment."
    }
  },
  "DIALOG": {
    "SEARCH": {
      "HEADER": "Parameter Management",
      "SUBHEADER": "Search and manage Parameters for configuring of Applications"
    },
    "NAVIGATION": {
      "SEARCH": {
        "LABEL": "Parameter",
        "TOOLTIP": "List of captured Parameters"
      },
      "DETAIL_USAGE": {
        "LABEL": "Usage Data",
        "TOOLTIP": "Usage data reported by Applications"
      },
      "LATEST_USAGE": {
        "LABEL": "Usage Data",
        "TOOLTIP": "Latest usage data reported by Applications"
      }
    },
    "DETAIL": {
      "COPY.HEADER": "Create Parameter",
      "CREATE.HEADER": "Create Parameter",
      "DELETE.HEADER": "Delete Parameter",
      "EDIT.HEADER": "Edit Parameter",
      "VIEW.HEADER": "Parameter Details",
      "TAB": {
        "PROPS": "Properties",
        "VALUE": "Value",
        ...
        "INTERN": "Internal",
        "TOOLTIPS": {
          "PROPS": "Base properties of the Parameter",
          "VALUE": "Value of the Parameter",
          "IMPORT_VALUE": "Imported Value of the Parameter",
          "INTERN": "Internal Properties"
        }
      },
      "CHARACTERS": "Still remaining characters"
    },
    "USAGE": {
      "HEADER": "Parameter Usage",
      "SUBHEADER": "Search and display the last use of parameters (reported by applications)",
      "TAB": {
        "OVERVIEW": "Summary",
        "LIST": "Value List",
        "CHART": "Timeline",
        "TOOLTIPS": {
          "OVERVIEW": "Overview on received values of the Parameter",
          "LIST": "List of values",
          "CHART": "Graphical presentation of the time line"
        }
      },
      "DETAIL": {
        "HEADER": "Usage Data Details",
        "LABEL": "Details"
      }
    },
    "CHART": {
  ...
  "PARAMETER": {
    ...
    "VALUE": "Value",
    "VALUE.EMPTY": "There is no value stored.",
    "VALUE.TYPE": "Type",
    ...
    "EQUAL": "Equal?",
    "TOOLTIPS": {
      "PRODUCT_NAME": "Application for which the Parameter is created",
      "APP_ID": "App identifier for which the Parameter is created",
      "APP_NAME": "App (service) for which the Parameter is created",
      "PRODUCT_APP": "Application and App (service) for which the Parameter is created",
      "NAME": "Name of the Parameter",
      "COMBINED_NAME": "Business Name or Name of the Parameter",
      "DISPLAY_NAME": "Business Name of the Parameter",
      "DESCRIPTION": "Detailed description of the Parameter",
      "VALUE": "Value of the Parameter - corresponds to the imported value if only this is available.",
      "VALUE.TYPE": "Type of Parameter value. If the types are different then both types.",
      "VALUE.TYPE.DETAIL": "Type of Parameter value.",
      "IMPORT_VALUE": "Imported value",
      "OPERATOR": "If set, the Workspace was created by automation",
      "EQUAL": "Comparison of value and imported value",
      "EQUAL.TRUE": "Value and imported value are equal",
      "EQUAL.FALSE": "Value and imported value are not equal",
      "EQUAL.UNDEFINED": "Not available because no value"
    }
  },
  "USAGE": {
    "COUNT": "Count",
    ...
    "EQUAL": "Equal?",
    "TOOLTIPS": {
      "COUNT": "How many times used within interval?",
      "START": "Start of timeframe",
      "END": "End of timeframe",
      "DURATION": "Period in which the Parameter was used with the supplied value",
      "INSTANCE_ID": "ID of the instance that used the Parameter",
      "DEFAULT_VALUE": "Default value",
      "USED_VALUE": "Used value",
      "LAST_USED": "Last used value",
      "EQUAL": "Comparison of value and imported value",
      "EQUAL.TRUE": "Used Value and default Value are equal",
      "EQUAL.FALSE": "Used Value and default Value are not equal",
      "EQUAL.UNDEFINED": "Not available because no value"
    }
  },
  "VALUE_TYPE": {
    ...
    "STRING": "Text",
    "UNKNOWN": "n.a.",
    "UNKNOWN.TOOLTIP": "Not available because no value"
  },
  "VALIDATION": {
    "JSON_FORMAT": "{ \"key\": \"value\", ... }",
    "ERRORS": {
      "PERSIST_ENTITY_FAILED": "A Parameter with this name already exists for the Application.",
      "EMPTY_REQUIRED_FIELD": "required field",
  ...
  "EXCEPTIONS": {
    "HTTP_STATUS_0": {
      "USAGE": "Unknown problem retrieving Parameter usage data - please try again.",
      "PARAMETER": "Unknown problem retrieving Parameter data - please try again.",
      "PARAMETERS": "Unknown problem retrieving Parameter data - please try again.",
      "PRODUCTS": "Unknown problem retrieving Application data - please try again."
    },
    "HTTP_STATUS_400": {
      "USAGE": "Your request could not be processed.",
      "PARAMETER": "Your request could not be processed.",
      "PARAMETERS": "Your request could not be processed.",
      "PRODUCTS": "Your request could not be processed."
    },
    "HTTP_STATUS_401": {
      "USAGE": "You are not authorized to see Parameter usage data.",
      "PARAMETER": "You are not authorized to see Parameter data.",
      "PARAMETERS": "You are not authorized to see Parameters.",
      "PRODUCTS": "You are not authorized to see Applications."
    },
    "HTTP_STATUS_403": {
      "USAGE": "You have no permissions to see Parameter usage data.",
      "PARAMETER": "You have no permissions to see Parameter data.",
      "PARAMETERS": "You have no permissions to see Parameters.",
      "PRODUCTS": "You have no permissions to see Applications."
    },
    "HTTP_STATUS_404": {
      "USAGE": "Parameter usage data could not be found.",
      "PARAMETER": "Parameter could not be found.",
      "PARAMETERS": "Parameters could not be found.",
      "PRODUCTS": "No Applications could be loaded."
    },
    "HTTP_STATUS_500": {
      "USAGE": "Unknown server problem retrieving Parameter usage data - please try again.",
      "PARAMETER": "Unknown server problem retrieving Parameter data - please try again.",
      "PARAMETERS": "Unknown server problem retrieving Parameter data - please try again.",
